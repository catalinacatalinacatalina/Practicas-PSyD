...
/* Planificaci�n est�tica de trabajos */
...
void main( void )
{
    ...
    uart0_puts( "\n\n Ejecutando una aplicaci�n cyclic executive\n" );
    uart0_puts(     " ------------------------------------------\n\n" ) ;
    ...
    pbs_open( isr_pb );                                          /* Instala isr_pbs como RTI por presi�n de pulsadores  */
