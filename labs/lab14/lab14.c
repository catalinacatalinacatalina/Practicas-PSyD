...
OS_STK Task8Stk[TASK_STK_SIZE]; // Tarea a�adida
OS_STK Task9Stk[TASK_STK_SIZE]; // Tarea a�adida
...
void Task6( void *id );
void Task7( void *id );
void Task8( void *id ); // Tarea a�adida
void Task9( void *id ); // Tarea a�adida
...
void TaskStart( void *pdata )
{
    ...
    const char id6 = '6';
    const char id7 = '7';
    const char id8 = '8'; // Identificador a�adido
    const char id9 = '9'; // Identificador a�adido
